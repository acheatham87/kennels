...
export const AnimalForm = () => {
    //State will contain both animal data as well a an isLoading flag.
    ...
    // you will need the `getAll` in the LocationsManager and CustomerManager to complete this section
    ...
    return (
        <form className="animalForm">
            <h2 classNames="animalForm__title">New Animal</h2>
            <fieldset>
